...
@section("content")
<div class="pd-20">
	<form action="/perm/user/create" method="post" class="form form-horizontal" id="form-perm-user-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" value="" placeholder="@" id="email" name="email" datatype="e" nullmsg="用户email不能为空">
            </div>
            <div></div>
        </div>
        <div class="row cl">
