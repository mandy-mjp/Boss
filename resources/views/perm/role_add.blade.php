...
@section("content")
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-perm-role-add">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>角色名称：</label>
			<div class="formControls col-7">
				<input type="text" class="input-text" value="" placeholder="用来判断权限的名称" id="user-name" name="name" datatype="*" nullmsg="角色名不能为空">
			</div>
			<div></div>
		</div>
		<div class="row cl">
            ...
            <div class="formControls col-7">
                <input type="text" class="input-text" value="" placeholder="显示给用户看的名称" id="user-name" name="display_name" datatype="*1-16" nullmsg="角色昵称不能为空">
            </div>
            <div></div>
        </div>
		<div class="row cl">
                ...
                <dl class="permission-list">
                    ...
                    <dd>
                        ...
                        <dl class="cl permission-list2">
                            ...
                            <dd>
                                <label class="">
                                    <input type="checkbox" value="{{ $val->id }}" name="role_check[]" id="user-Character-0-0-0">
                                    查看</label>
                                @forelse($val->son_perm as $k=>$v)
                                <label class="">
                                    <input type="checkbox" value="{{ $v->id }}" name="role_check[]" id="user-Character-0-0-1">
